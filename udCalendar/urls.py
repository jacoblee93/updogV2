...
urlpatterns = patterns('',
        ...
        url(r'^resolve_repeating_conflicts/$', views.resolve_repeating_conflicts, name='resolve_repeating_conflicts'),
        url(r'^event_conflicts/$', views.event_conflicts, name='event_conflicts'),
